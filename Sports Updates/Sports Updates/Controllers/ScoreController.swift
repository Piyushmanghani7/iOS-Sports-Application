...
extension ScoreController: UITableViewDataSource, UITableViewDelegate
{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
       // return self.NFLScore_data?.count ?? 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            //  cell.venue.text = self.NFLScore_data?[indexPath.row].Week!
...
//            let team1score4_int = self.MLBScor_data?[indexPath.row].AwayScoreQuarter4!
//            let team1score4_string = "\(team1score4_int!)"
...
//            let team2score4_int = self.MLBScor_data?[indexPath.row].HomeScoreQuarter4!
//            let team2score4_string = "\(team2score4_int!)"
